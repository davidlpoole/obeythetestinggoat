...
class ItemValidationTest(FunctionalTest):
    def get_error_element(self):
        return self.browser.find_element(by="css selector", value=".has-error")
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        self.wait_for(
            lambda: self.browser.find_element(
                by="css selector", value="#id_text:invalid"
            )
        )
        ...
        self.wait_for(
            lambda: self.browser.find_element(by="css selector", value="#id_text:valid")
        )
